...
### 完整直播占用：
#### 基本直播：
吟美核心+吟美分析+语音合成+WSL Docker+Vtube Studio人物+OBS = 内存-8G,显存-7.6G  
推荐台式机：内存-16G,显存-8~10G  
#### 对话直播：
吟美核心+吟美分析+吟美桌宠+语音合成+WSL Docker+Vtube Studio人物+OBS = 内存-10~13G,显存-9G  
推荐台式机：内存-32G,显存-16G  
