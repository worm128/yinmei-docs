...
方式一、[0.88元优惠秘钥](https://mall.bilibili.com/neul-next/detailuniversal/detail.html?page=detailuniversal_detail&itemsId=40254757&loadingShow=1&noTitleBar=1#noReffer=true&msource=merchant_share) | [购买年卡](https://mall.bilibili.com/neul-next/detailuniversal/detail.html?isMerchant=1&page=detailuniversal_detail&saleType=10&itemsId=12988851&loadingShow=1&noTitleBar=1&msource=merchant_share) | [唱歌功能](https://mall.bilibili.com/neul-next/detailuniversal/detail.html?page=detailuniversal_detail&itemsId=13024783&loadingShow=1&noTitleBar=1#noReffer=true&msource=merchant_share)    
...
##### 2、Window版本
**说明：** Window版本不支持vllm，我安装的是cuda12.9，应该兼容所有50系、40系Nvidia显卡，包括A100，A5000等显卡  
...
### 4、bert-vits2配置
#### 4.1、下载软件
- **如果你想语音合成速度更快，可以选择bert-vits2的产品**  
- <font color="red" style="font-weight:bold">整合包我已经放在网盘，yinmei-Bert-VITS2-ui.zip压缩包：</font>  
**吟美整合包下载地址：**  
百度网盘群：请在“百度网盘->消息” 添加群号   
百度网盘群号1：930109408（满）  
百度网盘群号2：939447713（满）   
...
夸克群2：428937868  
#### 4.2、模型切换
在根目录的config.yml文件，有一个参数models,里面有model和config，这里就是更换模型文件和模型配置的  
模型统一放在model_clap文件夹，进入model_clap文件夹，找到模型模型Elysia159000  
打开模型配置文件config.json，spk2id参数里面的值就是模型声音，把他放入吟美核心的主人物语音->说话人语音  
